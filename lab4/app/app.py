...
def valid_password(password):
    ...
    elif len(password) < 8: # Проверяем, что длина пароля не менее 8 символов
        return 'Пароль должен содержать не менее 8 символов.'
    elif len(password) > 128: # Проверяем, что длина пароля не более 128 символов
        return 'Пароль должен содержать не более 128 символов.'
    elif not any(char.isupper() for char in password): # Проверяем, что пароль содержит хотя бы одну заглавную букву
        return 'Пароль должен содержать хотя бы одну заглавную букву.'
    elif not any(char.islower() for char in password): # Проверяем, что пароль содержит хотя бы одну строчную букву
